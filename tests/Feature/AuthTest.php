...
class AuthTest extends TestCase
{
    ...
    public function test_login_fails_with_wrong_credentials(): void
    {
        ...
        // Generic message under the login field prevents email-enumeration via
        // distinct error keys.
    ...
    public function test_welcome_email_links_respect_configured_app_url(): void
    {
        config(['app.url' => 'https://vanriti.com']);
        \Illuminate\Support\Facades\URL::forceRootUrl('https://vanriti.com');
        ...
        $this->assertStringStartsWith('https://vanriti.com/', $mail->viewData['loginUrl']);
        $this->assertStringStartsWith('https://vanriti.com/', $mail->viewData['shopUrl']);
        $this->assertStringStartsWith('https://vanriti.com/', $mail->viewData['verifyUrl']);
    }
